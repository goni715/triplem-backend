...
router.post('/create-product', (0, AuthMiddleware_1.default)(user_constant_1.UserRole.admin, user_constant_1.UserRole.super_admin), upload_1.default.array("image", 5), Product_controller_1.default.createProduct);
