...
router.patch("/change-password", (0, AuthMiddleware_1.default)(user_constant_1.UserRole.owner, user_constant_1.UserRole.super_admin, user_constant_1.UserRole.user, user_constant_1.UserRole.administrator), (0, validationMiddleware_1.default)(auth_validation_1.changePasswordSchema), auth_controller_1.default.changePassword);
router.patch("/change-status/:id", (0, AuthMiddleware_1.default)(user_constant_1.UserRole.super_admin, user_constant_1.UserRole.administrator), (0, validationMiddleware_1.default)(auth_validation_1.changeStatusValidationSchema), auth_controller_1.default.changeStatus);
router.patch("/change-owner-status/:id", (0, AuthMiddleware_1.default)(user_constant_1.UserRole.super_admin, user_constant_1.UserRole.administrator), (0, validationMiddleware_1.default)(auth_validation_1.changeStatusValidationSchema), auth_controller_1.default.changeStatus);
router.delete("/delete-my-account", (0, AuthMiddleware_1.default)(user_constant_1.UserRole.owner, user_constant_1.UserRole.user), (0, validationMiddleware_1.default)(auth_validation_1.deleteAccountValidationSchema), auth_controller_1.default.deleteMyAccount);
