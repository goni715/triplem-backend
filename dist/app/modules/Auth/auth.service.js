...
const loginUserService = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.role !== "user") {
        throw new ApiError_1.default(400, `Sorry! You have no access to login`);
    }
    //create accessToken
...
const socialLoginService = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    //check the user
    ...
    if (!user) {
        ...
        //create accessToken
        const accessToken = (0, createToken_1.default)({ email: result.email, id: String(result._id), role: result.role }, config_1.default.jwt_access_secret, config_1.default.jwt_access_expires_in);
        //create refreshToken
        const refreshToken = (0, createToken_1.default)({ email: result.email, id: String(result._id), role: result.role }, config_1.default.jwt_refresh_secret, config_1.default.jwt_refresh_expires_in);
        return {
            accessToken,
            role: result.role,
            refreshToken,
